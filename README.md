...
| :---                                                   |     :---:                      |    :---:      |  ---:     |
|  [[Deep_image_prior]](https://arxiv.org/abs/1711.10925)| Deep convolutional networks (fitting a randomly-initialized ConvNet to corrupted images)   |  trained for classification on ImageNet ISLVRC   |  [[code]](https://github.com/DmitryUlyanov/deep-image-prior)         | 

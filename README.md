...
|[[Photo-realistic single image super-resolution using a generative adversarial network]](https://arxiv.org/abs/1609.04802)||||[[code]](https://github.com/tensorlayer/srgan)|generative adversarial network(Paper proposes  a perceptual
loss function which consists of an adversarial loss and a
content loss)||[[code]](https://github.com/tensorlayer/srgan)|

This repository is a paper list of image inpainting inspired by @1900zyh's repository [Awsome-Image-Inpainting](https://github.com/1900zyh/Awsome-Image-Inpainting), @geekyutao's repository [Image Inpainting](https://github.com/geekyutao/Image-Inpainting) and [[blog]](https://paperswithcode.com/task/image-inpainting) 
...
|[[Photo-realistic single image super-resolution using a generative adversarial network]](https://arxiv.org/abs/1609.04802)|generative adversarial network(Paper proposes  a perceptual loss function which consists of an adversarial loss and a content loss)|[[code]](https://github.com/tensorlayer/srgan)|

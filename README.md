...
|[[Learning Pyramid-Context Encoder Network for High-Quality Image Inpainting]](https://arxiv.org/abs/1904.07475)|PEN-Net (A Pyramid-context ENcoder Network for image inpainting by deep generative models. The PEN-Net is built upon a U-Net structure, which can restore an image by encoding contextual semantics from full resolution input, and decoding the learned semantic features back into images.|Facade DTD, CELEBA-HQ, Places2 |[[code]](https://github.com/researchmm/PEN-Net-for-Inpainting)|
